...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (r.ok) {
      ...
      setError(r.error || "Reset failed. Token may have expired.");
    }
  };
    ...
    <div style={{minHeight:"100vh",background:M.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:20,fontFamily:font}}>
      <div style={{width:"100%",maxWidth:400}}>
        <div style={{textAlign:"center",marginBottom:32}}>
          <div style={{fontSize:56,marginBottom:16}}>🔒</div>
          <div style={{...T.headlineM,color:M.onSurface}}>Set new password</div>
          <div style={{...T.bodyM,color:M.onSurfaceV,marginTop:4}}>Choose a strong password</div>
        </div>
